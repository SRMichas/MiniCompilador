...
public class FrameAbout extends JDialog
{
    ...
    public FrameAbout(JFrame panelContenedor)
    {   
    ...
    class PanelAcerca extends JPanel
    {
       private static final long serialVersionUID = 1L;
		...
		public PanelAcerca()
        {
         ...
         iconoTec = new ImageIcon(FrameAbout.class.getResource("/images/tec_logo.png"));
         ...
         labelLogo = new JLabel();
 		 ...
 		 icono = new ImageIcon(FrameAbout.class.getResource("/images/icono-96.png"));
